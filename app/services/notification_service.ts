...
import transmit from '@adonisjs/core/services/transmit'
...
export default class NotificationService {
  ...
  async create(
    ...
    try {
      ...
      emitter.emit(new NotificationCreated(notification))

      // Send real-time notification via SSE
      transmit
        .channel(`user:${userId}`)
        .emit('notification', NotificationDto.fromModel(notification))
