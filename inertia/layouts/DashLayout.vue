...
>
  ...
  <div class="border-t mt-2">
    ...
    <div class="flex-1 flex">
      ...
      <aside 
        class="fixed lg:sticky top-16 bottom-0 left-0 transition-all duration-300 
               ease-in-out overflow-hidden flex flex-col border-r bg-white z-[90]
      ...
      >
        ...
        <button
          class="hidden lg:block absolute -right-3 top-4 bg-background rounded-full 
                 p-1.5 border shadow-sm hover:bg-muted/50 transition-colors z-50"
          @click="isSidebarCollapsed = !isSidebarCollapsed"
        >
        ...
        <div class="border-t p-4">
          <button
            @click="$inertia.post('/logout')"
            class="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-muted/50 
                   transition-colors w-full text-destructive"
          >
