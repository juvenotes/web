...
<template>
  <ThemeProvider default-theme="system" storage-key="juvenotes-theme">
    <div class="min-h-screen flex flex-col bg-gray-50 dark:bg-background">
      <!-- Navigation Bar -->
      <nav
        class="sticky top-0 z-50 w-full bg-white border-b border-gray-100 dark:bg-background dark:border-border shadow-sm"
      >
        <div class="px-4 sm:px-6 lg:px-8">
          <div class="flex h-16 items-center justify-between">
            ...
            <div class="flex items-center gap-2">
              ...
              <!-- close relative user-menu div -->
            </div>
            <!-- close flex items-center gap-2 div -->
          </div>
        </div>
      </nav>
