...
const features = [
  { icon: 'bookpile.png', title: 'Comprehensive Resources', desc: 'Access a wide range of study materials' },
...
const stats = [
  { number: '636+', label: 'Active Students' },
  { number: '1200+', label: 'Practice Questions' },
