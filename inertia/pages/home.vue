...
<template>
  ...
  <div
    class="min-h-screen bg-gradient-to-br from-[#f0f9ff] via-[#e0f2fe] to-[#bae6fd] font-sans antialiased"
  >
    ...
    <main class="flex-1 w-full">
      <section class="py-16 md:py-24 w-full">
        <div class="w-full text-center">
          <div
            class="flex flex-col items-center justify-center gap-6 animate-fade-in mx-auto max-w-7xl px-4 sm:px-6 lg:px-8"
          >
            <div class="flex items-center justify-center gap-4 flex-wrap">
              <h1
                class="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 tracking-tight font-inter"
              >
            ...
            <h2 class="text-xl md:text-2xl font-medium text-[#55A9C4] mb-2">
              Study Smart, Excel Easy!
            </h2>
      ...
      <section class="py-16 md:py-20 bg-white/90 w-full">
        <div class="w-full">
          ...
          <div
            class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto"
          >
            <div
            ...
            >
              <div
                class="w-20 h-20 mx-auto mb-5 flex items-center justify-center bg-[#55A9C4]/10 rounded-full group-hover:bg-[#55A9C4]/20 transition-colors duration-300"
              >
                <img
              ...
              <h3
                class="text-xl font-semibold text-gray-900 mb-3 group-hover:text-[#55A9C4] transition-colors duration-300"
              >
                {{ feature.title }}
              </h3>
      ...
      >
        ...
        <div class="w-full relative z-10">
          <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            <div
              class="inline-block bg-white text-[#55A9C4] text-sm font-medium px-4 py-1.5 rounded-full mb-6"
            >
              Our Purpose
            </div>
      ...
      <section class="py-16 md:py-20 bg-white/90 w-full">
        <div class="w-full">
          <div
            class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto"
          >
            <div
