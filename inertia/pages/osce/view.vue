...
<template>
  ...
  <div class="w-full mx-auto px-2 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8 space-y-4 sm:space-y-6 font-sans">
    <!-- Header Section -->
    <div class="relative p-4 sm:p-6 bg-white rounded-xl border border-gray-100 shadow-lg hover:shadow-xl transition-shadow duration-300">
      <div class="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-[#55A9C4] via-[#55A9C4]/50 to-transparent rounded-t-xl" />

      <BreadcrumbTrail :items="breadcrumbItems" class="w-full overflow-x-auto pb-2 hide-scrollbar" />
      ...
      <div class="mt-4 sm:mt-6 flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
        <div class="flex items-start gap-3 flex-1">
          ...
          <div class="space-y-1">
            <h1 class="text-lg sm:text-xl font-semibold text-gray-900">{{ paper.title }}</h1>
            ...
            <div class="flex flex-wrap items-center gap-2 sm:gap-3 pt-1 sm:pt-2">
              <span class="px-2 py-0.5 text-xs font-semibold bg-[#55A9C4]/15 text-[#55A9C4] rounded-full shadow-sm">
                OSCE
              </span>
    ...
    <div class="bg-white p-4 sm:p-5 rounded-lg border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300">
      <div v-if="paperProgress.completionPercentage > 0" class="p-3 sm:p-4 bg-white/80 rounded-lg border border-[#55A9C4]/10 mb-3 sm:mb-4">
    ...
    <div class="space-y-4 sm:space-y-6">
      <template v-if="questions.length">
        <div
          ...
          class="p-3 sm:p-4 md:p-6 bg-white rounded-lg border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300 w-full"
        >
          <div class="space-y-3 sm:space-y-4">
            <!-- Question Header -->
            <div class="flex flex-col gap-2">
              <span class="inline-block w-fit px-3 sm:px-4 py-1 sm:py-1.5 bg-[#55A9C4]/15 text-[#55A9C4] rounded-lg font-semibold text-sm sm:text-base shadow-sm">
            ...
            <div class="mt-4 sm:mt-5 space-y-4 sm:space-y-5">
              <div
                class="bg-gradient-to-r from-[#55A9C4]/5 to-[#55A9C4]/0 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 w-full"
              >
                <!-- OSCE Parts Header -->
                <div
                  class="flex items-center justify-between px-3 sm:px-4 py-3 bg-[#55A9C4]/15 border-b border-[#55A9C4]/10"
                >
                  <div class="flex items-center gap-2">
                    <BookOpen class="h-4 w-4 text-[#55A9C4]" />
                    <span class="text-sm font-medium text-[#55A9C4]">OSCE Stations</span>
                  </div>
                  <div
                ...
                <div class="divide-y divide-[#55A9C4]/10">
                  <div
                    ...
                    :key="part.id"
                    class="px-3 sm:px-4 md:px-6 py-3 sm:py-4 bg-white/80 hover:bg-white/100 transition-all duration-300"
                  >
                    ...
                    <!-- Part Text -->
                    <p class="text-sm text-gray-900 break-words mb-3 sm:mb-4 leading-relaxed">
                      {{ part.partText }}
                    </p>
                    ...
                    <button
                      ...
                      class="group w-full flex items-center justify-center gap-2 mt-3 text-[#55A9C4] font-semibold text-xs sm:text-sm rounded-lg p-2 sm:p-2.5 bg-gradient-to-r from-[#55A9C4]/15 to-[#55A9C4]/5 hover:from-[#55A9C4]/25 hover:to-[#55A9C4]/15 border border-[#55A9C4]/20 transition-all duration-300 shadow-sm hover:shadow"
                    >
                      <ChevronDown
                    ...
                    <div v-if="showAnswers[part.id]" class="mt-4 animate-fadeIn">
                      <div class="relative overflow-hidden rounded-lg shadow-lg border border-gray-100 w-full">
                        ...
                        <div class="p-3 sm:p-4 bg-gradient-to-r from-[#55A9C4]/5 to-blue-50 border-b border-gray-100">
                          <div class="flex items-center gap-2">
                            <div class="flex items-center justify-center w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-[#55A9C4]/20 text-[#55A9C4]">
                      ...
                      <Button
                        variant="outline"
                        class="mt-4 flex items-center gap-2 sm:gap-3 bg-white hover:bg-gray-50 text-gray-700 border border-gray-200 transition-all duration-300 rounded-lg px-3 sm:px-4 py-2 sm:py-3 shadow-sm hover:shadow-md group text-xs w-full justify-center animate-fadeIn"
      ...
      <!-- Empty State -->
      <div v-else class="text-center py-8 sm:py-10 bg-white rounded-lg border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300">
...
.highlight-question {
  box-shadow: 0 0 0 2px rgba(85, 169, 196, 0.3);
}

/* Mobile optimization - make cards use full width */
