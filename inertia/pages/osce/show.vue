  ...
  <div class="min-h-screen bg-gray-50/50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
              ...
              <div class="group block p-4 sm:p-5 bg-white rounded-xl border border-gray-200 hover:border-[#55A9C4]/40 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-0.5">
                <div class="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-gray-500">Practice OSCE</p>
                  </div>
                </div>
              </div>
            </Link>
      ...
      <div v-else class="text-center py-12 sm:py-16 empty-state">
        <div class="mx-auto h-16 w-16 sm:h-20 sm:w-20 bg-amber-100 rounded-full flex items-center justify-center mb-4 sm:mb-5">
          <AlertCircle class="h-8 w-8 sm:h-10 sm:w-10 text-amber-500" />
        </div>
        <h3 class="text-lg sm:text-xl font-semibold text-gray-900 mb-2">No OSCE Papers Available Yet</h3>
