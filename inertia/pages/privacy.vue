  ...
  <div class="max-w-4xl mx-auto py-12 px-4">
    ...
    <div class="prose max-w-none space-y-8">
      <section>
        ...
        <p>
          At Juvenotes, we take your privacy seriously. This policy describes how we collect, use, 
      ...
      <section>
        ...
        <ul class="list-disc pl-6 space-y-2">
          <li><strong>Account Information:</strong> Name, email, password (encrypted), and profile picture</li>
          <li><strong>Educational Data:</strong> Course selections, institution details, study progress</li>
          <li><strong>Usage Data:</strong> Study time, learning streaks, and concept completion data</li>
          <li><strong>Authentication Data:</strong> When using Google Sign-In</li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul class="list-disc pl-6 space-y-2">
          ...
          <li>Secure SSL/TLS communication</li>
      ...
      <section>
        ...
        <p>
          ...
          <a href="mailto:privacy@juvenotes.com" class="text-primary hover:underline">
            privacy@juvenotes.com
          </a>
        </p>
      </section>
