...
import { BookOpen, FileText, Stethoscope, FileQuestion, Pin, Calendar, Users, School, GraduationCap } from 'lucide-vue-next'
...
<template>
  ...
  <div class="container mx-auto p-4 sm:p-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
      <div class="rounded-xl bg-gradient-to-br from-blue-100 via-white to-blue-50 shadow flex flex-col items-center p-6 border border-blue-100">
      ...
      <div class="rounded-xl bg-gradient-to-br from-fuchsia-100 via-white to-fuchsia-50 shadow flex flex-col items-center p-6 border border-fuchsia-100">
        ...
        <div class="text-sm text-fuchsia-700 font-semibold mt-1 tracking-wide uppercase">Papers</div>
      </div>
      <div class="rounded-xl bg-gradient-to-br from-emerald-100 via-white to-emerald-50 shadow flex flex-col items-center p-6 border border-emerald-100">
        ...
        <div class="text-sm text-emerald-700 font-semibold mt-1 tracking-wide uppercase">Questions</div>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
      ...
      >
        <div class="flex justify-center mb-3">
          <component :is="item.icon" class="w-10 h-10 text-blue-500 group-hover:text-blue-700 transition-colors" />
        </div>
        <div class="text-lg font-semibold text-slate-800 group-hover:text-blue-700">{{ item.name }}</div>
      </Link>
      <Link
