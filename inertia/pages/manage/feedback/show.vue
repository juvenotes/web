    ...
    <div class="max-w-3xl mx-auto py-10 px-4">
      ...
      <div class="bg-white rounded-xl shadow-lg p-8 mb-8 border border-gray-100">
        <div class="mb-6">
          ...
          <div v-if="props.question.questionImagePath" class="mb-4 flex justify-center">
            <img
              ...
              alt="Question Image"
              class="max-w-xs rounded-lg border border-gray-200 shadow"
            />
          </div>
        </div>
        <div v-if="props.question.isSaq && props.question.parts.length">
          ...
          <ul class="list-disc pl-8 space-y-1">
            <li
              ...
              :key="part.id"
              class="text-gray-800 flex items-center gap-2"
            >
              <input
        ...
        <div class="flex justify-end mt-8">
          <button v-if="!editing" class="btn btn-primary px-6 py-2 text-base" @click="startEdit">
            Edit Question Stem
          </button>
        </div>
        <div v-if="editing" class="mt-6">
          <textarea
            ...
            class="w-full border rounded p-3 mb-4 text-lg"
            rows="4"
          />
          <div class="flex gap-3 justify-end">
            <button class="btn btn-success px-6 py-2 text-base" @click="saveEdit">Save</button>
            <button class="btn btn-secondary px-6 py-2 text-base" @click="cancelEdit">
              Cancel
            </button>
          </div>
        </div>
      ...
      <div v-else class="space-y-4">
        <div
          ...
          :key="item.id"
          class="bg-gray-50 rounded-lg p-5 border border-gray-200 shadow-sm"
        >
