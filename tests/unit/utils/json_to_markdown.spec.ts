  ...
  test('should process bullet list nodes', ({ assert }) => {
    const json = {
      content: [
        {
          type: 'bulletList',
          content: [{ content: [{ text: 'First item' }] }, { content: [{ text: 'Second item' }] }],
        },
      ],
    }
  ...
  test('should process ordered list nodes', ({ assert }) => {
    const json = {
      content: [
        {
          type: 'orderedList',
          content: [{ content: [{ text: 'First step' }] }, { content: [{ text: 'Second step' }] }],
        },
      ],
    }
      ...
      content: [
        {
          ...
          content: [{ text: 'console.log("hello")' }, { text: 'const x = 1' }],
        },
      ],
    }
  ...
  test('should handle complex mixed content', ({ assert }) => {
    const json = {
      content: [
        ...
        {
          type: 'bulletList',
          content: [{ content: [{ text: 'Point one' }] }, { content: [{ text: 'Point two' }] }],
        },
      ],
    }
